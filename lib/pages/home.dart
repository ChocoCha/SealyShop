  ...
  if (queryResultSet.isEmpty && value.length == 1) {
    DatabaseMethod().search(value).then((QuerySnapshot docs) {
      ...
      tempSearchStore = queryResultSet
          .where((element) =>
              element['UpdatedName'].toString().toLowerCase().startsWith(searchValue))
          .toList();
                ...
                children: [
                  ...
                  ? Expanded(
                    child: ListView(
                        ...
                        shrinkWrap: true,
                        // ✅ แก้ไขการใช้ .map()
                        children: tempSearchStore.map((element) => buildResultCard(element)).toList(),
                      ),
                  )
          ...
          child: Row(
            children: [
              ClipRRect(
                ...
                child: Image.network(data["Image"],height: 50,width: 50,fit: BoxFit.cover,)),
                SizedBox(width: 20.0,),
